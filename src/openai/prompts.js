...
The caption pairs should have one short version that is a single sentence description and the second should be a more detailed 2 sentence expansion on the first caption from the reading. \
\
